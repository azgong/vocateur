...
export function ResultsUpsell({ sessionId }: { sessionId: string }) {
  return (
    ...
    >
      <h3 className="small-caps font-[family-name:var(--font-display)] text-3xl font-medium tracking-tight">
      ...
      <p className="max-w-md text-sm text-white/70">
        ...
        grounded in real labor-market data for your matched field &mdash; ask it anything, or run a real mock
      ...
      <p className="text-xs text-white/50">$9/mo or $79/yr &mdash; cancel anytime</p>
    </div>
  );
}
