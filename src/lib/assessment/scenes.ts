...
export const CHAPTERS: Chapter[] = [
  {
    ...
    caseStudy:
      "You're three weeks into a junior analyst job at a small investment firm. Your boss is out sick, the client call starts in ten minutes, and the numbers on your screen need to make sense before it does.",
    scenes: [
      {
        type: "timedSelect",
        id: "spot_anomaly",
        ...
        prompt: "Every region's revenue should be almost exactly double what it was two years ago. One region badly breaks that pattern, even though its current number won't look unusual at a glance. Find it before time runs out.",
        items: [
          { id: "north", primaryLabel: "North", secondaryLabel: "$2.1M two years ago, $4.2M now", correct: false },
          { id: "south", primaryLabel: "South", secondaryLabel: "$1.8M two years ago, $3.6M now", correct: false },
          { id: "east", primaryLabel: "East", secondaryLabel: "$2.4M two years ago, $4.8M now", correct: false },
          { id: "west", primaryLabel: "West", secondaryLabel: "$2.0M two years ago, $2.6M now", correct: true },
          { id: "central", primaryLabel: "Central", secondaryLabel: "$1.5M two years ago, $3.0M now", correct: false },
          { id: "pacific", primaryLabel: "Pacific", secondaryLabel: "$2.2M two years ago, $4.4M now", correct: false },
        ],
        timeLimitMs: 25000,
        ...
        confirmVerb: "Lock in",
        description: "catching which region quietly missed a stated two-year doubling pattern, not just the biggest number on screen",
      },
      {
        type: "choice",
        id: "diagnose_outage",
        ...
        prompt: "The store's checkout page just started failing for 12% of customers. You have one message before things escalate further. What do you check first?",
        confirmLabel: "Go with this",
        options: [
          { id: "diff_deploys", label: "Pull up the last 3 changes that were made to the site and compare them.", traitContribution: { quadrant_a: 0.95, quadrant_b: 0.4, quadrant_c: 0.05, quadrant_d: 0.15 } },
          { id: "traffic_correlation", label: "Check if it lines up with a surge of visitors from one region.", traitContribution: { quadrant_a: 0.85, quadrant_b: 0.2, quadrant_c: 0.1, quadrant_d: 0.55 } },
          { id: "ask_oncall", label: "Ask the teammate on duty tonight what they're seeing on their end first.", traitContribution: { quadrant_a: 0.4, quadrant_b: 0.3, quadrant_c: 0.7, quadrant_d: 0.15 } },
          { id: "rollback", label: "Undo the most recent change immediately, ask questions after.", traitContribution: { quadrant_a: 0.3, quadrant_b: 0.15, quadrant_c: 0.1, quadrant_d: 0.4 } },
        ],
        description: "diagnosing a website outage with one shot before it escalates",
      },
      {
        type: "choice",
        id: "trust_the_model",
        chapterId: "analyst",
        title: "Trust the spreadsheet or the colleague",
        prompt: "Your spreadsheet says the company isn't worth what you're being asked to pay for it, off by 15%. A colleague who's done this 20 times says the numbers are missing something you can't measure. You present in an hour.",
        confirmLabel: "Go with this",
        options: [
          { id: "quantify_it", label: "Rebuild the spreadsheet, turning her point into an actual number.", traitContribution: { quadrant_a: 0.95, quadrant_b: 0.55, quadrant_c: 0.15, quadrant_d: 0.2 } },
          ...
          { id: "trust_her", label: "Trust her experience and go with her gut read.", traitContribution: { quadrant_a: 0.35, quadrant_b: 0.2, quadrant_c: 0.6, quadrant_d: 0.3 } },
          { id: "trust_model", label: "Trust the numbers: hard data over gut feeling, every time.", traitContribution: { quadrant_a: 0.97, quadrant_b: 0.3, quadrant_c: 0.05, quadrant_d: 0.1 } },
        ],
        description: "deciding whether to trust a spreadsheet over a colleague's gut call",
      },
      {
        type: "ranking",
        ...
        prompt: "Your boss wants a yes-or-no recommendation on whether to buy this company by Friday. Five things still need checking. Order them by which should be tackled first to catch a dealbreaker fastest.",
        displayOrder: [
          { id: "audit", primaryLabel: "Check that the financial numbers actually add up", secondaryLabel: "Make sure nothing was hidden or miscounted" },
          { id: "legal", primaryLabel: "Review legal risk", secondaryLabel: "Any pending lawsuits or rule-breaking" },
          { id: "customer_concentration", primaryLabel: "Check how spread out their customers are", secondaryLabel: "How much of their income comes from just a few clients" },
          { id: "management_background", primaryLabel: "Check out the founders' track record", secondaryLabel: "Talk to people who've worked with them before" },
          { id: "competitive_landscape", primaryLabel: "See who else is competing for the same customers", secondaryLabel: "Who else is trying to win this market" },
        ],
        ...
        description: "sequencing five research tasks to catch a dealbreaker fastest",
      },
      {
        type: "choice",
        id: "model_midnight",
        ...
        prompt: "It's midnight. The big presentation is at 9am. Your spreadsheet is off by $2M and you can't find the error. What do you do?",
        confirmLabel: "Go with this",
        options: [
          { id: "rebuild_from_scratch", label: "Rebuild the spreadsheet from scratch, checking every formula.", traitContribution: { quadrant_a: 0.95, quadrant_b: 0.55, quadrant_c: 0.05, quadrant_d: 0.15 } },
          ...
          { id: "flag_the_partner", label: "Message your boss now and be upfront about the mistake.", traitContribution: { quadrant_a: 0.55, quadrant_b: 0.3, quadrant_c: 0.75, quadrant_d: 0.15 } },
          { id: "estimate_and_footnote", label: "Estimate the gap, write down your assumption, and move on.", traitContribution: { quadrant_a: 0.4, quadrant_b: 0.25, quadrant_c: 0.15, quadrant_d: 0.75 } },
        ],
        description: "deciding how to handle a spreadsheet that doesn't add up the night before a big presentation",
      },
      {
        type: "timedSelect",
        id: "catch_memo_error",
        chapterId: "analyst",
        title: "Catch the error in the note",
        prompt: "This note goes to the client in ten minutes. Skim it once. One line has an error that doesn't belong. Find it.",
        items: [
          { id: "rev_line", primaryLabel: "Revenue grew 12% year over year to $4.2M.", secondaryLabel: "", correct: false },
          { id: "margin_line", primaryLabel: "Profit margin held steady at 61% for the third straight quarter.", secondaryLabel: "", correct: false },
          { id: "headcount_line", primaryLabel: "Headcount grew from 40 to 52 employees this quarter.", secondaryLabel: "", correct: false },
          { id: "typo_line", primaryLabel: "The share of customers who leave dropped to 9% from 6% last quarter.", secondaryLabel: "", correct: true },
          { id: "cash_line", primaryLabel: "Cash on hand now lasts 14 months after the latest funding round.", secondaryLabel: "", correct: false },
          { id: "nps_line", primaryLabel: "Customer satisfaction score rose 8 points to 42.", secondaryLabel: "", correct: false },
        ],
        timeLimitMs: 15000,
        ...
        confirmVerb: "Flag",
        description: "catching an erroneous line in a client note before it goes out",
      },
      {
        type: "dragRank",
        ...
        prompt:
          "Your boss wants one number: last year's true revenue. Four sources disagree. Drag them into the order you'd trust, most reliable on top, then lock it in.",
        items: [
          { id: "deck", primaryLabel: "The founder's slideshow for investors", secondaryLabel: "Made to impress, not to be exact" },
          { id: "bank", primaryLabel: "Bank statements for the year", secondaryLabel: "Raw money in and out, not double-checked" },
          { id: "audited", primaryLabel: "The official year-end financial report", secondaryLabel: "Checked and signed off by outside accountants last quarter" },
          { id: "crm", primaryLabel: "The sales team's own tracking sheet", secondaryLabel: "Numbers the sales team entered themselves" },
        ],
        correctOrder: ["audited", "bank", "crm", "deck"],
        primaryQuadrant: "quadrant_a",
        secondaryQuadrant: "quadrant_b",
        confirmLabel: "Lock in the order",
        description: "ranking four conflicting revenue sources by how much you'd trust each one",
      },
    ],
  },
  {
    ...
    scenes: [
      {
        ...
        displayOrder: [
          { id: "wrist", primaryLabel: "Wrist injury after a fall", secondaryLabel: "Visible deformity, pain steady, been like this an hour already" },
          { id: "chest_pain", primaryLabel: "Chest pain, sweating, going gray", secondaryLabel: "Pain radiating down the left arm, getting worse by the minute" },
          { id: "ankle", primaryLabel: "Twisted ankle", secondaryLabel: "Mild swelling, can still walk on it, waiting since this morning" },
          { id: "allergic", primaryLabel: "Face and throat swelling", secondaryLabel: "Struggling to breathe, lips turning blue" },
          { id: "meningitis", primaryLabel: "High fever, stiff neck", secondaryLabel: "104°F, getting more confused by the minute" },
        ],
      ...
      },
      {
        ...
        displayOrder: [
          ...
          { id: "followup", primaryLabel: "Bed 6 needs a follow-up call", secondaryLabel: "To their regular doctor tomorrow" },
        ],
      ...
      {
        type: "timedSelect",
        id: "spot_the_mismatch",
        chapterId: "physician",
        title: "Spot the chart that doesn't match",
        prompt: "Every patient's paper chart should show the same birth date as their wristband. Scan the six pairs, one doesn't match.",
        items: [
          { id: "chart1", primaryLabel: "Chart: 03/14/1987", secondaryLabel: "Wristband: 03/14/1987", correct: false },
          { id: "chart2", primaryLabel: "Chart: 11/02/1990", secondaryLabel: "Wristband: 11/02/1990", correct: false },
          { id: "chart3", primaryLabel: "Chart: 06/23/1975", secondaryLabel: "Wristband: 06/28/1975", correct: true },
          { id: "chart4", primaryLabel: "Chart: 09/30/2001", secondaryLabel: "Wristband: 09/30/2001", correct: false },
          { id: "chart5", primaryLabel: "Chart: 01/17/1968", secondaryLabel: "Wristband: 01/17/1968", correct: false },
          { id: "chart6", primaryLabel: "Chart: 04/05/1993", secondaryLabel: "Wristband: 04/05/1993", correct: false },
        ],
        timeLimitMs: 15000,
        ...
        confirmVerb: "Flag",
        description: "catching a chart-to-wristband mismatch under time pressure",
      },
      {
        type: "ranking",
        id: "restock_wave",
      ...
      },
      {
        ...
        items: [
          { id: "discharge_am", primaryLabel: "Stable patient going home in the morning", secondaryLabel: "Paperwork already done" },
          { id: "sepsis_watch", primaryLabel: "Post-op patient, fever climbing for two hours", secondaryLabel: "Nurse says it's not slowing down" },
          { id: "insulin", primaryLabel: "Diabetic patient on medication that needs monitoring", secondaryLabel: "Routine check every hour, nothing unusual so far" },
          { id: "chest_obs", primaryLabel: "Chest-pain patient still being ruled out", secondaryLabel: "One more overnight test before anyone can say it's nothing" },
        ],
  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        chapterId: "executive",
        title: "Read the room",
        prompt: "The morning team meeting just ended. One teammate needs a check-in before the day gets away from you. Skim the last hour of messages: who is it?",
        items: [
          { id: "pr_up", primaryLabel: "\"on it, will have the report up by 2\"", secondaryLabel: "", correct: false },
          { id: "rough_morning", primaryLabel: "\"sorry, having a rough morning, might be a bit slow today\"", secondaryLabel: "", correct: true },
          { id: "shipped_fix", primaryLabel: "\"fixed the issue, all good now\"", secondaryLabel: "", correct: false },
          { id: "push_1on1", primaryLabel: "\"can we push our one-on-one to tomorrow? swamped\"", secondaryLabel: "", correct: false },
      ...
      },
      {
        ...
        displayOrder: [
          ...
          { id: "intro_team", primaryLabel: "Schedule a short intro chat with each teammate", secondaryLabel: "So they feel like part of the group fast" },
  ...
  },
  {
    ...
    caseStudy:
      "Eight months after launch, your starting money won't last forever, and the calendar keeps moving whether the product is ready or not. You're the one who has to decide where the next dollar and the next month go.",
    scenes: [
      {
        type: "allocation",
        id: "allocate_runway",
        chapterId: "founder",
        title: "Allocate your remaining time and money",
        prompt: "You've got 100 points of budget and six months of money left. Split it however you want. There's no correct answer here.",
        categories: [
          ...
          { id: "runway", label: "Savings", hint: "Keep cash in the bank in case things go sideways" },
        ],
        concentrationQuadrant: "quadrant_d",
        balanceQuadrant: "quadrant_b",
        balanceCategoryId: "runway",
        confirmLabel: "Ship this plan",
        description: "allocating a startup's budget across product, marketing, hiring, and savings",
      },
      {
        type: "choice",
        id: "pick_the_bet",
        ...
        options: [
          ...
          { id: "wild_idea", label: "The wild idea that could massively grow the business but might flop.", traitContribution: { quadrant_a: 0.3, quadrant_b: 0.1, quadrant_c: 0.15, quadrant_d: 0.97 } },
      ...
      },
      {
        ...
        prompt: "Growth has been flat for 6 weeks. Half your team thinks you should change direction on the core product. The other half says stay the course and fix the sign-up experience.",
        confirmLabel: "Make the call",
        options: [
          { id: "pivot", label: "Change direction: flat growth for 6 weeks is a real signal.", traitContribution: { quadrant_a: 0.35, quadrant_b: 0.1, quadrant_c: 0.2, quadrant_d: 0.95 } },
          { id: "fix_onboarding", label: "Stay the course, fix the sign-up experience first, revisit in a month.", traitContribution: { quadrant_a: 0.5, quadrant_b: 0.6, quadrant_c: 0.3, quadrant_d: 0.35 } },
          { id: "call_churned_users", label: "Get on calls with 10 users who quit this week before deciding.", traitContribution: { quadrant_a: 0.45, quadrant_b: 0.25, quadrant_c: 0.75, quadrant_d: 0.5 } },
          { id: "split_team", label: "Split the team: half testing a new direction, half on the sign-up experience.", traitContribution: { quadrant_a: 0.35, quadrant_b: 0.4, quadrant_c: 0.35, quadrant_d: 0.7 } },
        ],
      ...
      },
      {
        ...
        displayOrder: [
          { id: "burn_rate", primaryLabel: "How much are you spending each month, and how long will your money last?", secondaryLabel: "The number every investor asks first" },
      ...
      },
      {
        ...
        prompt: "Your cofounder wants to raise a lot of new investment money right now. You think it's too soon and gives away too much ownership too early. You need to agree before the board call tomorrow.",
        confirmLabel: "Make the call",
        options: [
          { id: "raise_now", label: "Back it. Money and momentum now beats caution.", traitContribution: { quadrant_a: 0.3, quadrant_b: 0.15, quadrant_c: 0.25, quadrant_d: 0.9 } },
          { id: "hold_off", label: "Hold off. Prove the business is working first, then raise on better terms later.", traitContribution: { quadrant_a: 0.65, quadrant_b: 0.55, quadrant_c: 0.2, quadrant_d: 0.35 } },
      ...
      },
      {
        ...
        id: "demo_day_split",
        chapterId: "founder",
        title: "Split your pitch time",
        prompt: "You've got 3 minutes on stage in front of investors and 100 points of attention to give. Split it across what you actually want the room to remember.",
        categories: [
          { id: "vision", label: "The big vision", hint: "Where this goes in 5 years" },
          { id: "traction", label: "Progress and numbers", hint: "What's actually working right now" },
      ...
      },
      {
        ...
        items: [
          { id: "onboarding", primaryLabel: "Rebuild the sign-up experience end to end", secondaryLabel: "Three weeks of engineering" },
          { id: "churn_calls", primaryLabel: "Call the last five customers who quit", secondaryLabel: "A day of brutal but free feedback" },
          { id: "deck", primaryLabel: "Polish the investor slideshow", secondaryLabel: "Only matters if the numbers improve" },
  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        prompt: "The prototype loses motor control at random, but sensors and power stay rock solid the whole time. Given that pattern, which joint would you check first before the enclosure closes for good?",
        items: [
          { id: "power_rail", primaryLabel: "Joint 1, power rail", secondaryLabel: "Feeds constant voltage to the whole board", correct: false },
          { id: "ground", primaryLabel: "Joint 2, ground", secondaryLabel: "Shared return path for every component", correct: false },
          { id: "sensor_bus", primaryLabel: "Joint 3, sensor bus", secondaryLabel: "Carries data from all the sensors", correct: false },
          { id: "motor_driver", primaryLabel: "Joint 4, motor driver", secondaryLabel: "The only connection feeding the motor controller", correct: true },
          { id: "status_led", primaryLabel: "Joint 5, status LED", secondaryLabel: "Just an indicator light, nothing else depends on it", correct: false },
          { id: "battery_lead", primaryLabel: "Joint 6, battery lead", secondaryLabel: "Supplies power to the entire board", correct: false },
        ],
        timeLimitMs: 20000,
        ...
        confirmVerb: "Mark it",
        description: "reasoning from a symptom pattern to the one joint that actually explains it, ruling out power, ground, and sensors along the way",
      },
      {
        type: "choice",
        ...
        options: [
          ...
          { id: "redo_cad", label: "Redo the 3D design precisely, resubmit it to print, and wait the two days.", traitContribution: { quadrant_b: 0.75, quadrant_a: 0.5, builder_instinct: 0.4 } },
